...
const AppRouter = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/coach" element={<ProtectedWithLayout><CoachPage /></ProtectedWithLayout>} />
      <Route path="/simulate" element={<ProtectedWithLayout><SimulatePage /></ProtectedWithLayout>} />
