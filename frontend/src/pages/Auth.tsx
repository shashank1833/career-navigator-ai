...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="floating-orb w-80 h-80 bg-primary/10 top-1/3 -left-40" />
      ...
      >
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-3">
            ...
            <h1 className="text-3xl font-extrabold text-foreground">CareerNav</h1>
          </div>
        ...
        <div className="flat-card p-6">
          ...
          <div className="mt-4 text-center text-sm text-muted-foreground">
            {isLogin ? (
              <>Don't have an account?{" "}<button onClick={() => setIsLogin(false)} className="text-primary hover:underline font-medium">Sign up free</button></>
            ) : (
